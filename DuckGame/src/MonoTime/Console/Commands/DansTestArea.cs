...
namespace DuckGame
{
    public static class DansTestArea
    {
        ...
        public static void SetControllerLightBar(int index, Color color)
        {
            ...
            GamePadState state = GamePad.GetState(playerIndex, GamePadDeadZone.IndependentAxes);
            //GamePadState state = GamePad.GetState(index, GamePadDeadZone.IndependentAxes); old

            if (state.IsConnected)
            {
                GamePad.SetLightBarEXT(playerIndex, (Microsoft.Xna.Framework.Color)color);
                //GamePad.SetLightBarEXT(index, (Microsoft.Xna.Framework.Color)color); old
            }
        }
