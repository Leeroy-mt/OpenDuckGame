    ...
    public class Resolution
    {
            ...
            else
            {
                switch (Options.LocalData.currentResolution.mode)
                {
                    case ScreenMode.Windowed:
                        ...
                        SDL.SDL_SetWindowBordered(MonoMain.instance.Window.Handle, false ? false : true);// Resolution._window.FormBorderStyle = FormBorderStyle.FixedSingle;
                    ...
                    case ScreenMode.Borderless:
                        ...
                        SDL.SDL_SetWindowBordered(MonoMain.instance.Window.Handle, true ? false : true); //  Resolution._window.FormBorderStyle = FormBorderStyle.None;
        ...
        public static bool Update()
        {
            if (_takeFocus > 0)
            {
                ...
                //SDL.SDL_SetWindowInputFocus(MonoMain.instance.Window.Handle); old
