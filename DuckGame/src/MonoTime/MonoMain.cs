...
namespace DuckGame
{
    public class MonoMain : Game
    {
        ...
        public static string GetInfiniteLoopDetails()
        {
            ...
            //string str = new StackTrace(mainThread, true).ToString(); old
            string str = new StackTrace(true).ToString(); //new
        ...
        protected override void Initialize()
        {
            ...
            if (Program.doscreentileing)
            {
                ...
                Resolution.Set(r);
                Resolution.Apply();
                SDL.SDL_SetWindowBordered(instance.Window.Handle, /*SDL.SDL_bool.SDL_FALSE old*/ false /*new*/);
