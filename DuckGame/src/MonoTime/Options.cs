    ...
    public static class Options
    {
        ...
        public static void ScreenModeChanged(string pMode)
        {
            if (pMode == "Fullscreen")
            {
                ...
                //int windowindex = SDL2.SDL.SDL_GetWindowDisplayIndex(MonoMain.instance.Window.Handle); old
                //if (windowindex >= 0 && windowindex < GraphicsAdapter.Adapters.Count) old
                {
                    //GraphicsAdapter currentdisplay = GraphicsAdapter.Adapters[windowindex]; old
                    GraphicsAdapter currentdisplay = GraphicsAdapter.DefaultAdapter;
