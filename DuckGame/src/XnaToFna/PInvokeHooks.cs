...
using Control = XnaToFna.ProxyForms.Control;
using Cursor = XnaToFna.ProxyForms.Cursor;
using Form = XnaToFna.ProxyForms.Form;
using Keys = Microsoft.Xna.Framework.Input.Keys;
using Message = XnaToFna.ProxyForms.Message;
