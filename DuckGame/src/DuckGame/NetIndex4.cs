...
public struct NetIndex4 : IComparable
{
	...
	public int CompareTo(object obj)
	{
		...
		if (obj is NetIndex4 otherIndex)
		{
			if (this < otherIndex)
			{
				return -1;
	...
	public static implicit operator NetIndex4(int val)
	{
		return new NetIndex4(val);
	}

	public static implicit operator int(NetIndex4 val)
	{
		return val._index;
	}
