...
public struct Matrix : IEquatable<Matrix>
{
    ...
    public Vec3 Down
    {
        get
        {
            return new Vec3(0f - M21, 0f - M22, 0f - M23);
        }
        set
        {
            M21 = 0f - value.x;
    ...
    public Vec3 Forward
    {
        get
        {
            return new Vec3(0f - M31, 0f - M32, 0f - M33);
        }
        set
        {
            M31 = 0f - value.x;
    ...
    public Vec3 Left
    {
        get
        {
            return new Vec3(0f - M11, 0f - M12, 0f - M13);
        }
        set
        {
            M11 = 0f - value.x;
    ...
    {
        Vec3.Normalize(ref forward, out var z);
        Vec3.Cross(ref forward, ref up, out var x);
        Vec3.Cross(ref x, ref forward, out var y);
        x.Normalize();
        y.Normalize();
    ...
    {
        CreateShadow(ref lightDirection, ref plane, out var ret);
        return ret;
    }
    ...
    {
        CreateReflection(ref value, out var ret);
        return ret;
    }
    ...
    {
        Transform(ref value, ref rotation, out var ret);
        return ret;
    }
    ...
    public bool Decompose(out Vec3 scale, out Quaternion rotation, out Vec3 translation)
    {
        ...
        Matrix m1 = new Matrix(M11 / scale.x, M12 / scale.x, M13 / scale.x, 0f, M21 / scale.y, M22 / scale.y, M23 / scale.y, 0f, M31 / scale.z, M32 / scale.z, M33 / scale.z, 0f, 0f, 0f, 0f, 1f);
    ...
    {
        CreateBillboard(ref objectPosition, ref cameraPosition, ref cameraUpVector, cameraForwardVector, out var ret);
        return ret;
    }
    ...
    public static void CreateBillboard(ref Vec3 objectPosition, ref Vec3 cameraPosition, ref Vec3 cameraUpVector, Vec3? cameraForwardVector, out Matrix result)
    {
        ...
        Vec3.Normalize(ref translation, out var backwards);
        Vec3.Normalize(ref cameraUpVector, out var up);
        Vec3.Cross(ref backwards, ref up, out var right);
    ...
    {
        CreateFromQuaternion(ref quaternion, out var ret);
        return ret;
    }
    ...
    {
        CreateLookAt(ref cameraPosition, ref cameraTarget, ref cameraUpVector, out var ret);
        return ret;
    }
    ...
    public static void CreateLookAt(ref Vec3 cameraPosition, ref Vec3 cameraTarget, ref Vec3 cameraUpVector, out Matrix result)
    {
        ...
        result.M32 = vy.z;
        result.M33 = vz.z;
        result.M41 = 0f - Vec3.Dot(vx, cameraPosition);
        result.M42 = 0f - Vec3.Dot(vy, cameraPosition);
        result.M43 = 0f - Vec3.Dot(vz, cameraPosition);
    }

    public static Matrix CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane)
    {
        CreateOrthographic(width, height, zNearPlane, zFarPlane, out var ret);
        return ret;
    }
    ...
    {
        CreateOrthographicOffCenter(left, right, bottom, top, zNearPlane, zFarPlane, out var ret);
        return ret;
    }
    ...
    {
        CreatePerspectiveFieldOfView(fieldOfView, aspectRatio, nearPlaneDistance, farPlaneDistance, out var ret);
        return ret;
    }
    ...
    public static Matrix CreateRotationX(float radians)
    {
        ...
        returnMatrix.M32 = 0f - returnMatrix.M23;
    ...
    public static Matrix CreateRotationY(float radians)
    {
        ...
        returnMatrix.M31 = 0f - returnMatrix.M13;
    ...
    public static Matrix CreateRotationZ(float radians)
    {
        ...
        returnMatrix.M21 = 0f - returnMatrix.M12;
    ...
    public static void Invert(ref Matrix matrix, out Matrix result)
    {
        ...
        ret.M12 = ((0f - matrix.M12) * det12 + matrix.M13 * det11 - matrix.M14 * det10) * invDetMatrix;
        ret.M13 = (matrix.M42 * det6 - matrix.M43 * det5 + matrix.M44 * det4) * invDetMatrix;
        ret.M14 = ((0f - matrix.M32) * det6 + matrix.M33 * det5 - matrix.M34 * det4) * invDetMatrix;
        ret.M21 = ((0f - matrix.M21) * det12 + matrix.M23 * det9 - matrix.M24 * det8) * invDetMatrix;
        ret.M22 = (matrix.M11 * det12 - matrix.M13 * det9 + matrix.M14 * det8) * invDetMatrix;
        ret.M23 = ((0f - matrix.M41) * det6 + matrix.M43 * det3 - matrix.M44 * det2) * invDetMatrix;
        ret.M24 = (matrix.M31 * det6 - matrix.M33 * det3 + matrix.M34 * det2) * invDetMatrix;
        ret.M31 = (matrix.M21 * det11 - matrix.M22 * det9 + matrix.M24 * det7) * invDetMatrix;
        ret.M32 = ((0f - matrix.M11) * det11 + matrix.M12 * det9 - matrix.M14 * det7) * invDetMatrix;
        ret.M33 = (matrix.M41 * det5 - matrix.M42 * det3 + matrix.M44 * det1) * invDetMatrix;
        ret.M34 = ((0f - matrix.M31) * det5 + matrix.M32 * det3 - matrix.M34 * det1) * invDetMatrix;
        ret.M41 = ((0f - matrix.M21) * det10 + matrix.M22 * det8 - matrix.M23 * det7) * invDetMatrix;
        ret.M42 = (matrix.M11 * det10 - matrix.M12 * det8 + matrix.M13 * det7) * invDetMatrix;
        ret.M43 = ((0f - matrix.M41) * det4 + matrix.M42 * det2 - matrix.M43 * det1) * invDetMatrix;
    ...
    public float Determinant()
    {
        ...
        return M11 * (M22 * minor6 - M23 * minor5 + M24 * minor4) - M12 * (M21 * minor6 - M23 * minor3 + M24 * minor2) + M13 * (M21 * minor5 - M22 * minor3 + M24 * minor1) - M14 * (M21 * minor4 - M22 * minor2 + M23 * minor1);
    }
