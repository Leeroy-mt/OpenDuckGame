...
public struct Vec3 : IEquatable<Vec3>
{
    ...
    {
        return new Vec3(MathHelper.Clamp(value1.x, min.x, max.x), MathHelper.Clamp(value1.y, min.y, max.y), MathHelper.Clamp(value1.z, min.z, max.z));
    }
    ...
    {
        return new Vec3(MathHelper.Lerp(value1.x, value2.x, amount), MathHelper.Lerp(value1.y, value2.y, amount), MathHelper.Lerp(value1.z, value2.z, amount));
    }

    public static void Lerp(ref Vec3 value1, ref Vec3 value2, float amount, out Vec3 result)
    {
        result = new Vec3(MathHelper.Lerp(value1.x, value2.x, amount), MathHelper.Lerp(value1.y, value2.y, amount), MathHelper.Lerp(value1.z, value2.z, amount));
    }

    public static Vec3 Max(Vec3 value1, Vec3 value2)
    {
        return new Vec3(MathHelper.Max(value1.x, value2.x), MathHelper.Max(value1.y, value2.y), MathHelper.Max(value1.z, value2.z));
    }

    public static void Max(ref Vec3 value1, ref Vec3 value2, out Vec3 result)
    {
        result = new Vec3(MathHelper.Max(value1.x, value2.x), MathHelper.Max(value1.y, value2.y), MathHelper.Max(value1.z, value2.z));
    }

    public static Vec3 Min(Vec3 value1, Vec3 value2)
    {
        return new Vec3(MathHelper.Min(value1.x, value2.x), MathHelper.Min(value1.y, value2.y), MathHelper.Min(value1.z, value2.z));
    }

    public static void Min(ref Vec3 value1, ref Vec3 value2, out Vec3 result)
    {
        result = new Vec3(MathHelper.Min(value1.x, value2.x), MathHelper.Min(value1.y, value2.y), MathHelper.Min(value1.z, value2.z));
    }
    ...
    {
        float factor = 1f / (float)Math.Sqrt(value.x * value.x + value.y * value.y + value.z * value.z);
        value.x *= factor;
        value.y *= factor;
        value.z *= factor;
        return value;
    ...
    public static Vec3 Reflect(Vec3 vector, Vec3 normal)
    {
        ...
        vector.x -= dotTimesTwo * normal.x;
        vector.y -= dotTimesTwo * normal.y;
        vector.z -= dotTimesTwo * normal.z;
        return vector;
    }
    ...
    {
        return new Vec3(MathHelper.SmoothStep(value1.x, value2.x, amount), MathHelper.SmoothStep(value1.y, value2.y, amount), MathHelper.SmoothStep(value1.z, value2.z, amount));
    }

    public static void SmoothStep(ref Vec3 value1, ref Vec3 value2, float amount, out Vec3 result)
    {
        result = new Vec3(MathHelper.SmoothStep(value1.x, value2.x, amount), MathHelper.SmoothStep(value1.y, value2.y, amount), MathHelper.SmoothStep(value1.z, value2.z, amount));
    }
    ...
    {
        result = new Vec3(position.x * matrix.M11 + position.y * matrix.M21 + position.z * matrix.M31 + matrix.M41, position.x * matrix.M12 + position.y * matrix.M22 + position.z * matrix.M32 + matrix.M42, position.x * matrix.M13 + position.y * matrix.M23 + position.z * matrix.M33 + matrix.M43);
    }
    ...
    public static void Transform(Vec3[] sourceArray, int sourceIndex, ref Matrix matrix, Vec3[] destinationArray, int destinationIndex, int length)
    {
        throw new NotImplementedException();
    }

    public static void Transform(Vec3[] sourceArray, int sourceIndex, ref Quaternion rotation, Vec3[] destinationArray, int destinationIndex, int length)
    {
        throw new NotImplementedException();
    }
    ...
    public static void TransformNormal(Vec3[] sourceArray, int sourceIndex, ref Matrix matrix, Vec3[] destinationArray, int destinationIndex, int length)
    {
        throw new NotImplementedException();
    }
    ...
    {
        result = new Vec3(normal.x * matrix.M11 + normal.y * matrix.M21 + normal.z * matrix.M31, normal.x * matrix.M12 + normal.y * matrix.M22 + normal.z * matrix.M32, normal.x * matrix.M13 + normal.y * matrix.M23 + normal.z * matrix.M33);
    }
    ...
    {
        value = new Vec3(0f - value.x, 0f - value.y, 0f - value.z);
        return value;
    }
