...
public class SpawnAimer : Thing
{
    ...
    public override void Draw()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            Vector2 dir = new Vector2((float)Math.Cos(Maths.DegToRad(a)), (float)(0.0 - Math.Sin(Maths.DegToRad(a))));
        ...
        bool hasPrev = false;
        foreach (Vector2 pos in prevPos)
        {
            if (hasPrev)
            {
                Vector2 dir2 = Vector2.Normalize(posPrev - pos);
