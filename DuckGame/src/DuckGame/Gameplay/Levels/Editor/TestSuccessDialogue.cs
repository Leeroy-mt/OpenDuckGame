...
public class TestSuccessDialogue : ContextMenu
{
    ...
    public override void Update()
    {
        ...
        Vector2 okPos = new Vector2(vec.X - 5f, bottomRight.Y - 70f) + new Vector2(18f, 28f);
        Vector2 okSize = new Vector2(135f, 30f);
        Vector2 cancelPos = new Vector2(vec.X + 136f, bottomRight.Y - 70f) + new Vector2(18f, 28f);
        Vector2 cancelSize = new Vector2(135f, 30f);
    ...
    public override void Draw()
    {
        if (base.opened)
        {
            ...
            Vector2 okPos = new Vector2(topLeft.X - 5f, bottomRight.Y - 70f) + new Vector2(18f, 28f);
            Vector2 okSize = new Vector2(135f, 30f);
            Vector2 cancelPos = new Vector2(topLeft.X + 136f, bottomRight.Y - 70f) + new Vector2(18f, 28f);
            Vector2 cancelSize = new Vector2(135f, 30f);
