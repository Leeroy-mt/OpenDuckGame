...
public class MainPage : Page, IPageListener
{
    ...
    public override void TransitionOutComplete()
    {
        ...
        {
            Level.current = new UploadPage(_cards, grid: true);
        }
    }
    ...
    public override void Initialize()
    {
        ...
        Level.Add(g);
        StripInfo editors = new StripInfo(l: false);
        editors.cards.Add(new Card("Level Editor"));
        editors.cards.Add(new Card("Hat Editor"));
        editors.cards.Add(new Card("Weapon Editor"));
        editors.cards.Add(new Card("Sandwich Editor"));
        editors.cards.Add(new Card("Religion Editor"));
        editors.header = "Editors";
        editors.cardsVisible = 4;
        g.AddStrip(editors);
        if (_cards.Count > 4)
        {
    ...
    public override void PostDrawLayer(Layer layer)
    {
        if (layer == Layer.HUD)
        {
            ...
            font.ScaleX = xscale;
            _font.Draw("Workshop", 8f, 8f, Color.White, 0.95f);
        }
    }
}
