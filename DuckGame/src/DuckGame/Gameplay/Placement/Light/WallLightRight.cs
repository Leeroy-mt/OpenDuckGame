...
public class WallLightRight : Thing
{
        ...
        : base(xpos, ypos)
    {
        ...
        _collisionOffset = new Vector2(2f, -8f);
        base.Depth = 0.9f;
    ...
    public override void Initialize()
    {
        ...
        {
            _occluders.Add(new LightOccluder(base.topLeft, base.topRight + new Vector2(2f, 0f), new Color(1f, 0.8f, 0.8f)));
            _occluders.Add(new LightOccluder(base.bottomLeft, base.bottomRight + new Vector2(2f, 0f), new Color(1f, 0.8f, 0.8f)));
