...
public class PyramidBackground : BackgroundUpdater
{
	...
	public override void Initialize()
	{
		if (!(Level.current is Editor))
		{
			...
			_parallax.AddZone(18, 0.9f, speed, moving: true);
			_parallax.AddZone(19, 0.8f, speed, moving: true);
			_parallax.AddZone(20, 0.7f, speed, moving: true);
			_parallax.AddZone(21, 0.6f, speed, moving: true);
			_parallax.AddZone(22, 0.6f, speed, moving: true);
			_parallax.AddZone(23, 0.5f, speed, moving: true);
			_parallax.AddZone(24, 0.5f, speed, moving: true);
			Level.Add(_parallax);
		}
	}
