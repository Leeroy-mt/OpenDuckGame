...
{
    public EditorProperty<float> Zoom = new EditorProperty<float>(1f, null, 0.25f, 5f);

    public EditorProperty<bool> Overfollow = new EditorProperty<bool>(val: false);

    public EditorProperty<bool> Allow_Warps = new EditorProperty<bool>(val: false);
    ...
    {
        base.zoomMult = Zoom.value;
        overFollow = Overfollow.value;
        allowWarps = Allow_Warps.value;
        base.Initialize();
    }
}
