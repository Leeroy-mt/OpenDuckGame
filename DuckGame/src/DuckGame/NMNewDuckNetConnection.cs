...
public class NMNewDuckNetConnection : NMDuckNetwork
{
	...
	public NMNewDuckNetConnection(Profile pProfile, string id, string duckName, Team varTeam, byte varFlippers, bool parentalControls, int varFlagIndex, ulong pProfileID, byte pPersona)
	{
		identifier = id;
		name = duckName;
		team = varTeam;
