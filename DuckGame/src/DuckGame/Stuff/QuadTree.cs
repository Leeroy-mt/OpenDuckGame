...
public class QuadTree
{
    ...
    public Thing CheckPoint(Type pType, Vector2 pos, Thing ignore)
    {
    ...
    public T CheckPoint<T>(Vector2 pos, Thing ignore, Layer layer)
    {
        QuadTree current = this;
        Type typer = typeof(T);
        int index = 0;
    ...
    public T CheckPoint<T>(Vector2 pos, Thing ignore)
    {
        QuadTree current = this;
        Type typer = typeof(T);
        int index = 0;
    ...
    public T CheckPointFilter<T>(Vector2 pos, Func<Thing, bool> pFilter)
    {
        QuadTree current = this;
        Type typer = typeof(T);
        int index = 0;
    ...
    public T CheckPoint<T>(Vector2 pos)
    {
        QuadTree current = this;
        Type typer = typeof(T);
        int index = 0;
    ...
    public Thing CheckPoint(Vector2 pos, Type typer, Thing ignore, Layer layer)
    {
        QuadTree current = this;
        int index = 0;
        while (current != null)
    ...
    public Thing CheckPoint(Vector2 pos, Type typer, Thing ignore)
    {
        QuadTree current = this;
        int index = 0;
        while (current != null)
    ...
    public Thing CheckPoint(Vector2 pos, Type typer)
    {
        QuadTree current = this;
        int index = 0;
        while (current != null)
    ...
    public T CheckPointPlacementLayer<T>(Vector2 pos, Thing ignore = null, Layer layer = null)
    {
        QuadTree current = this;
        Type typer = typeof(T);
        int index = 0;
    ...
    public T CheckPointFilter<T>(Vector2 pos, Predicate<Thing> filter)
    {
        QuadTree current = this;
        Type typer = typeof(T);
        int index = 0;
    ...
    public T CheckLine<T>(Vector2 p1, Vector2 p2, Thing ignore, Layer layer)
    {
        recurse.Clear();
        recurse.Push(this);
    ...
    public T CheckLine<T>(Vector2 p1, Vector2 p2, Thing ignore)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckLine<T>(Vector2 p1, Vector2 p2)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public List<T> CheckLineAll<T>(Vector2 p1, Vector2 p2, Thing ignore, Layer layer)
    {
        recurse.Clear();
        recurse.Push(this);
    ...
    public List<T> CheckLineAll<T>(Vector2 p1, Vector2 p2, Thing ignore)
    {
        recurse.Clear();
        recurse.Push(this);
        List<T> list = new List<T>();
    ...
    public List<T> CheckLineAll<T>(Vector2 p1, Vector2 p2)
    {
        recurse.Clear();
        recurse.Push(this);
        List<T> list = new List<T>();
    ...
    public T CheckLinePoint<T>(Vector2 p1, Vector2 p2, out Vector2 hit, Thing ignore, Layer layer)
    {
        hit = default(Vector2);
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
        {
            ...
            if (!current._split)
            {
                ...
                foreach (Thing t in current._objects[typer])
                {
                    ...
                    {
                        Vector2 p3 = Collision.LinePoint(p1, p2, t);
                        if (p3 != Vector2.Zero)
                        {
                            hit = p3;
                            return (T)(object)t;
    ...
    public T CheckLinePoint<T>(Vector2 p1, Vector2 p2, out Vector2 hit, Thing ignore)
    {
        hit = default(Vector2);
        recurse.Clear();
        recurse.Push(this);
    ...
    public T CheckLinePoint<T>(Vector2 p1, Vector2 p2, out Vector2 hit)
    {
        hit = default(Vector2);
        recurse.Clear();
        recurse.Push(this);
    ...
    public T CheckRectangleFilter<T>(Vector2 p1, Vector2 p2, Predicate<T> filter, Layer layer)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckRectangleFilter<T>(Vector2 p1, Vector2 p2, Predicate<T> filter)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckRectangle<T>(Vector2 p1, Vector2 p2, Thing ignore, Layer layer)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckRectangle<T>(Vector2 p1, Vector2 p2, Thing ignore)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckRectangle<T>(Vector2 p1, Vector2 p2)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public void CheckRectangleAll<T>(Vector2 p1, Vector2 p2, List<T> outList)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckCircle<T>(Vector2 p1, float radius, Thing ignore, Layer layer)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckCircle<T>(Vector2 p1, float radius, Thing ignore)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public T CheckCircle<T>(Vector2 p1, float radius)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public void CheckCircleAll<T>(Vector2 p1, float radius, List<object> outList)
    {
        recurse.Clear();
        recurse.Push(this);
        while (recurse.Count > 0)
    ...
    public void Draw()
    {
        Graphics.DrawRect(_position, _position + new Vector2(_width, _width), Color.Red, 1f, filled: false);
        if (!_split)
        {
            Graphics.DrawString(Change.ToString(_objects.Count), _position + new Vector2(2f, 2f), Color.White, 0.9f);
            Graphics.DrawString(Change.ToString(_personalIDX), _position + new Vector2(2f, 16f), Color.White, 0.9f, null, 0.5f);
            foreach (Thing t in _objects)
            {
