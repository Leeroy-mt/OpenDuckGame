...
public class UISlotEditor(UIMenu closeMenu, float xpos, float ypos, float wide = -1, float high = -1)
    : UIMenu("", xpos, ypos, wide, high)
{
    #region Public Fields

    public static bool editingSlots;
            ...
            else
            {
                ...
                if (Input.Pressed("MENURIGHT"))
                {
                    if (_indexX == 0 && _indexY == 2)
                        ...
                        _indexX = int.Min(++_indexX, 2);
                }
                if (Input.Pressed("MENUUP"))
                {
                    _indexY = int.Max(--_indexY, 0);
                }
