...
public class NMPop : NMEvent
{
	...
	public static void AmazingDisappearingParticles(Vec2 pPos)
	{
		...
		for (int i = 0; i < 6; i++)
		{
			...
			Level.Add(ConfettiParticle.New(pPos.x + Rando.Float(-6f, 0f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(-1f, 0f), Rando.Float(-1f, 1f)), 0.02f, lineType: true));
			Level.Add(ConfettiParticle.New(pPos.x + Rando.Float(0f, 6f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(0f, 1f), Rando.Float(-1f, 1f)), 0.02f, lineType: true));
		}
	...
	public static void AmazingDisappearingParticles(Vec2 pPos, Layer pLayer)
	{
		...
		for (int i = 0; i < 6; i++)
		{
			ConfettiParticle confettiParticle = ConfettiParticle.New(pPos.x + Rando.Float(-6f, 0f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(-1f, 0f), Rando.Float(-1f, 1f)));
			...
			ConfettiParticle confettiParticle3 = ConfettiParticle.New(pPos.x + Rando.Float(-6f, 0f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(-1f, 0f), Rando.Float(-1f, 1f)), 0.02f, lineType: true);
			confettiParticle3.layer = pLayer;
			Level.Add(confettiParticle3);
			ConfettiParticle confettiParticle4 = ConfettiParticle.New(pPos.x + Rando.Float(0f, 6f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(0f, 1f), Rando.Float(-1f, 1f)), 0.02f, lineType: true);
