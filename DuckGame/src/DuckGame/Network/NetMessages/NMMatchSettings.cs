...
public class NMMatchSettings : NMDuckNetworkEvent
{
	...
	public NMMatchSettings(bool initial, byte varWinsPerSet, byte varRoundsPerIntermission, byte varRandomPercent, byte varWorkshopPercent, byte varNormalPercent, bool varTeams, byte varCustomPercent, int varCustomLevels, bool varWallmode, List<byte> enabledModifiers, bool varClientLevels)
	{
	...
	protected override void OnSerialize()
	{
		...
		foreach (byte b in _enabledModifiers)
		{
