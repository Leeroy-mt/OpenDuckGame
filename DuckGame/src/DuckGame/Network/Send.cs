...
public class Send
{
    public static void Resend(NetMessage msg)
    {
        Network.activeNetwork.QueueMessage(msg, msg.connection);
    }
    ...
    public static void Message(NetMessage msg, NetMessagePriority priority, List<NetworkConnection> pConnections)
    {
        Network.activeNetwork.QueueMessage(msg, priority, pConnections);
    }

    public static void MessageToAllBut(NetMessage msg, NetMessagePriority priority, NetworkConnection who)
    {
        if (who != DuckNetwork.localConnection)
        {
