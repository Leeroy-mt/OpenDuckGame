...
public class Basketball : Holdable
{
	...
	public override void Update()
	{
		...
		else if (base.duck != null && base.duck.holdObject == this)
		{
			if (_framesInHand < 0)
			{
				_framesInHand = 0;
			...
			{
				_bounceDuck = base.duck;
				float hspd = base.duck.hSpeed;
				base.duck.ThrowItem(throwWithForce: false);
				vSpeed = 2f;
				hSpeed = hspd * 1.1f;
				_framesInHand = 0;
			}
			...
			{
				if (Math.Abs(owner.hSpeed) > 0.5f && base.duck.grounded)
				{
					_walkFrames++;
				}
