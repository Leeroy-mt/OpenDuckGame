...
namespace XnaToFna
{
    public static class DeviceEvents
    {
        ...
        public static void Update()
        {
            ...
            {
                var playerIndex = (PlayerIndex)i; //new
                bool isConnected = GamePad.GetState(playerIndex, GamePadDeadZone.IndependentAxes).IsConnected;
                //bool isConnected = GamePad.GetState(i, GamePadDeadZone.IndependentAxes).IsConnected; old
